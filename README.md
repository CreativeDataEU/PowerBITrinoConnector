...
In ase you encounter any issues while installting or loading data, then feel free to reach out to the contributor of this repository. 

## Trino client REST API#
The connector is communicating directly with the Trino client REST API to retrieve data:
